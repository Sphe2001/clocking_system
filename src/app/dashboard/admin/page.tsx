      ...
      <main className="flex-1 bg-white text-black p-6 shadow-md">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          {summaryData.map(({ title, value }) => (
            <div key={title} className="bg-gray-100 text-black p-4 rounded-lg shadow-md text-center border border-gray-300">
        ...
        <div className="mb-4">
          ...
          <select className="border border-gray-300 p-2 rounded-md text-black bg-white shadow-sm" value={roleFilter} onChange={handleFilterChange}>
              ...
              {filteredRecords.length > 0 ? (
                filteredRecords.map((record, index) => (
                  <tr key={index} className="text-center hover:bg-gray-100">
                    ...
                    <td className={`border border-gray-300 p-2 font-semibold ${record.status === "Late" ? "text-yellow-600" : record.status === "Absent" ? "text-red-600" : record.status === "Attended" ? "text-green-600" : "text-gray-600"}`}>
                      {record.status}
                    </td>
                ...
                <tr>
                  <td colSpan={8} className="text-center p-4 text-gray-500">No attendance records found.</td>
                </tr>
              )}
            </tbody>
          </table>
